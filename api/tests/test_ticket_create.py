...
class ParkUpdateTestCase(TestCase):
    ...
    def test_ticket_create_valid(self):
        ...
        response = self.client.post('/api/user/ticket/', create_ticket_data, HTTP_AUTHORIZATION='Token ' + self.user_token.key)
    ...
    def test_ticket_create_invalid_date(self):
        create_ticket_data = {
            "park_id": self.park.pk,
            "date": ''
        }
    ...
    def test_ticket_create_invalid_date_outside_park(self):
        existing_park_data = ParkSerializer(self.park).data
    ...
    def test_ticket_create_invalid_no_park_id(self):
    ...
    def test_park_update_invalid_park_belongs_to_other_user(self):
        ...
        response = self.client.post('/api/user/ticket/', create_ticket_data, HTTP_AUTHORIZATION='Token ' + user2_token.key)
        response_content = json.loads(response.content)
    ...
    def test_ticket_create_not_authenticated(self):
        ticket_date = self.park.start + datetime.timedelta(hours=1)
        ...
        response = self.client.post('/api/user/ticket/', create_ticket_data)
        response_content = json.loads(response.content)
